...
if (isset($_SESSION['Place Order'])) // checking whether the session set or not
        {
            echo "<br>";
            echo $_SESSION['Place Order']; //displaying session messsage
            unset($_SESSION['Place Order']); // revoming session message
            unset($_SESSION['cart']);
        } ?>
<section id="hero">
